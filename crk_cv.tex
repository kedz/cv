...
\Description{Gain insight into general and robust techniques for automatic text understanding and their application to automatic summarization.}\vspace{2em} % Goal text
...
\NewEntry{August 2014}{Summarizing Disasters Over Time}
